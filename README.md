...
Lifewood Book Creative Portal 是面向客户的书籍视频项目资料提交平台。客户可以保存草稿、上传真实素材并提交不可变的项目资料包；内部人员通过管理中心维护账号和业务选项、跟进已提交项目，并上传最终成品。平台支持已批准的书籍资料辅助识别，不执行视频生产或生成。Lifewood 是开发公司名称，项目简称为 Book Creative Portal。

...
export function StepProgress({ current, highestReachable, onNext, canContinue = false, busy = false }: {
  current: number; highestReachable: number; onNext?: () => void; canContinue?: boolean; busy?: boolean;
}) {

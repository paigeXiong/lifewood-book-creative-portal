      ...
      <div className="voice-layout"><div className="form-stack">
        <section className="form-panel voice-settings"><div className="section-heading"><div><h2><span>3.1</span>{t("voice.sections.settings")}</h2><p>{t("voice.settingsHint")}</p></div></div>
          <div className="form-grid voice-grid">
            <Field label={t("voice.fields.contentLanguage")} htmlFor="voice-content-language" required error={form.formState.errors.contentLanguageId?.message}><select id="voice-content-language" autoComplete="off" {...form.register("contentLanguageId")}><option value="" /><Options items={contentLanguageOptions} /></select></Field>
            <Field label={t("voice.fields.narrationTone")} htmlFor="narration-tone" required error={form.formState.errors.narrationToneId?.message}><select id="narration-tone" autoComplete="off" {...form.register("narrationToneId")}><option value="" /><Options items={narrationToneOptions} /></select></Field>
            <Field label={t("voice.fields.speechRate")} htmlFor="speech-rate" required error={form.formState.errors.speechRateId?.message}><select id="speech-rate" autoComplete="off" {...form.register("speechRateId")}><option value="" /><Options items={speechRateOptions} /></select></Field>
            <Field label={t("voice.fields.voiceGender")} htmlFor="voice-gender"><select id="voice-gender" autoComplete="off" {...form.register("voiceGenderId")}><option value="" /><Options items={voiceGenderOptions} /></select></Field>
            <Field label={t("voice.fields.voiceAge")} htmlFor="voice-age"><select id="voice-age" autoComplete="off" {...form.register("voiceAgeId")}><option value="" /><Options items={voiceAgeOptions} /></select></Field>
            <Field label={t("voice.fields.accent")} htmlFor="voice-accent"><select id="voice-accent" autoComplete="off" {...form.register("accentId")}><option value="" /><Options items={accentOptions} /></select></Field>
            <Field label={t("voice.fields.emotionStyle")} htmlFor="voice-emotion"><select id="voice-emotion" autoComplete="off" {...form.register("emotionStyleId")}><option value="" /><Options items={emotionOptions} /></select></Field>

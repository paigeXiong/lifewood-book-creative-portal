  ...
  return <div className={`wizard-page voice-page ${stage}-page`}>
    ...
    <form autoComplete="off" onSubmit={continueStep} inert={navigating} aria-busy={navigating}>
      <div className="voice-layout"><div className="form-stack">
        ...
        }}><section className="form-panel voice-settings"><div className="section-heading"><div className="field-help-heading"><h2><span>3.1</span>{t("voice.sections.settings")}</h2><HelpPopover label={t("voice.sections.settings")}>{t("voice.settingsHint")}</HelpPopover></div></div>

...
const groups = ["brands", "video-goals", "audiences", "genres", "content-languages", "video-durations", "publishing-platforms", "role-types", "age-ranges", "genders", "visual-styles", "mood-tags", "image-style-tags", "pace-tags", "narration-tones", "speech-rates", "voice-genders", "voice-ages", "accents", "voice-emotions"] as const;

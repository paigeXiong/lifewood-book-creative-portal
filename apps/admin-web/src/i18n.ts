...
i18n.addResourceBundle(
  ...
  "translation",
  {
    ...
    admin: {
      ...
      runtime: {
        networkTitle: "监听设置",
        networkDescription: "设置客户和管理员访问平台时使用的协议、监听地址与端口。保存后需要重启平台才会生效。",
        scheme: "访问协议",
        ...
        activeEndpoint: "当前访问地址",
        pendingEndpoint: "重启后地址",
  ...
  "translation",
  {
    ...
    admin: {
      ...
      runtime: {
        ...
        networkDescription: "Configure the protocol, address, and port used by customers and administrators. Saved changes take effect after a platform restart.",
        scheme: "Protocol",
        ...
        pendingEndpoint: "Endpoint after restart",

...
i18n.addResourceBundle(
  ...
  "translation",
  {
    ...
    admin: {
      ...
      runtime: {
        networkTitle: "监听设置",
        networkDescription: "设置客户和管理员访问平台时使用的监听地址与端口。保存后需要重启平台才会生效。",
        listenAddress: "监听地址",
        listenAddressHint: "127.0.0.1 仅监听本机；0.0.0.0 接受其他设备连接，但远程访问必须经过可信 HTTPS 反向代理。",
        port: "端口",
        ...
        restartConfirmBody: "所有当前连接会短暂中断。平台将使用已经保存的监听地址和端口重新启动。",
  ...
  "translation",
  {
    ...
    admin: {
      ...
      runtime: {
        ...
        networkDescription: "Configure the address and port used by customers and administrators. Saved changes take effect after a platform restart.",
        listenAddress: "Listen address",
        listenAddressHint: "Use 127.0.0.1 for local-only binding. 0.0.0.0 accepts other devices, but remote access must use a trusted HTTPS reverse proxy.",
        port: "Port",
        ...
        restartConfirmBody: "All current connections will be interrupted briefly. The platform will restart with the saved address and port.",

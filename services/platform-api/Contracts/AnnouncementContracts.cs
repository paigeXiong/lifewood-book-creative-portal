...
public sealed record AnnouncementInput(string TitleZh, string BodyZh, string TitleEn, string BodyEn, string Placement, string Audience, string[] Languages, string[] OrganizationIds, string? StartsAt, string? EndsAt, long Version = 0);

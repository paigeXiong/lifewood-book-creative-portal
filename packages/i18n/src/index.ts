...
i18n.addResourceBundle("zh-CN", "translation", { organizationMember: { view: "查看 {{name}} 的个人资料", back: "返回我的组织", backProjects: "返回项目列表", unavailable: "无法查看此成员，成员可能已离开当前组织。" } }, true, true);
i18n.addResourceBundle("en-US", "translation", { organizationMember: { view: "View {{name}}’s profile", back: "Back to my organization", backProjects: "Back to projects", unavailable: "This member is unavailable. They may no longer belong to your organization." } }, true, true);
...
i18n.addResourceBundle("zh-CN","translation",{tasks:{columns:{creator:"创建人"},viewProject:"查看项目"},projectProgress:{draft:"资料尚未提交，仅创建人可以继续编辑。",returned:"资料已退回，等待创建人修改或回复。"}},true,true);
i18n.addResourceBundle("en-US","translation",{tasks:{columns:{creator:"Created by"},viewProject:"View project"},projectProgress:{draft:"This draft has not been submitted. Only its creator can continue editing.",returned:"Changes have been requested. Awaiting an update or reply from the creator."}},true,true);

i18n.addResourceBundle("zh-CN", "translation", {"help": {"title": "帮助中心", "audience": "文档版本", "customer": "客户文档", "admin": "管理文档", "search": "搜索功能、问题或操作步骤", "find": "搜索", "clear": "清除搜索", "forbidden": "当前账号无法查看管理文档。", "loading": "正在加载文档…", "retry": "重试", "results": "找到 {{count}} 篇文档", "contents": "文档目录", "back": "返回文档目录", "updated": "更新于 {{date}}", "steps": "操作步骤", "enlarge": "放大查看截图", "imageAlt": "{{title}}：界面示例", "screenshotNote": "独立演示环境截图，截于 2026-09-18。账号和项目均为虚构示例，点击图片可放大。", "faq": "常见问题与解决办法", "close": "关闭", "notFound": "当前文档不可用，或不在搜索结果中。", "empty": "没有找到匹配文档，请尝试更短的关键词，例如“邮箱”或“退回”。"}}, true, true);

i18n.addResourceBundle("en-US", "translation", {"help": {"title": "Help center", "audience": "Documentation audience", "customer": "Customer guides", "admin": "Admin guides", "search": "Search features, questions or steps", "find": "Search", "clear": "Clear search", "forbidden": "This account cannot access administrator documentation.", "loading": "Loading documentation…", "retry": "Retry", "results": "Found {{count}} articles", "contents": "Documentation contents", "back": "Back to all guides", "updated": "Updated {{date}}", "steps": "Steps", "enlarge": "Enlarge screenshot", "imageAlt": "{{title}}: interface example", "screenshotNote": "Captured in an isolated demo environment on September 18, 2026. Accounts and projects are fictional examples. Select the image to enlarge.", "faq": "FAQ and troubleshooting", "close": "Close", "notFound": "This article is unavailable or outside the current search results.", "empty": "No matching articles. Try a shorter keyword such as “email” or “revision”."}}, true, true);

i18n.addResourceBundle("zh-CN", "translation", { dashboard: { scopeLabel: "统计范围", scope: { personal: "个人", organization: "组织" } } }, true, true);
i18n.addResourceBundle("en-US", "translation", { dashboard: { scopeLabel: "Scope", scope: { personal: "Personal", organization: "Organization" } } }, true, true);
...
i18n.addResourceBundle("zh-CN", "translation", {"invitation": {"title": "邀请码管理", "register": "邀请注册", "create": "创建邀请码", "code": "邀请码", "note": "备注", "organization": "所属组织", "creator": "创建人", "created": "创建时间", "expires": "到期时间", "usage": "已使用 / 名额", "days": "有效天数", "limit": "可注册人数", "records": "使用记录", "reveal": "查看邀请码", "disable": "停用", "disableConfirm": "停用后，尚未完成的注册将无法加入组织。确定停用吗？", "search": "搜索备注、组织或创建人", "all": "全部状态", "allOrgs": "全部组织", "chooseOrg": "选择组织", "empty": "暂无符合条件的邀请码", "noMembers": "尚无账号通过此码注册", "joined": "注册时间", "closed": "已注销账号", "name": "姓名", "email": "邮箱", "password": "密码", "confirmPassword": "确认密码", "next": "验证邀请码", "send": "发送验证邮件", "sent": "如果邮箱可以注册且未触发发送限制，验证邮件已发送。请在 10 分钟内打开邮件继续；未收到时可在 60 秒后重试，已有账号请直接登录。", "join": "即将加入：{{organization}}", "finish": "验证邮箱并创建账号", "done": "账号已创建，邮箱已验证。请登录。", "copied": "已复制", "copy": "复制邀请码", "copyFailed": "复制失败，请手动选择邀请码复制。", "help": "新邀请码为 6 位大写英文字母，输入不区分大小写；旧码仍然有效。持有人可注册加入该组织并查看共享项目。默认单次使用，最长有效期 90 天、最多 100 人。过期自动失效，保留使用记录；不会影响已注册账号。", "registerHelp": "邀请码绑定组织。完成邮箱验证后设置姓名和密码，创建客户成员账号。现有账号不会因邀请码更换组织。", "refresh": "刷新", "previous": "上一页", "nextPage": "下一页", "page": "第 {{page}} 页 · 共 {{count}} 条", "clear": "清除筛选", "status": "状态", "actions": "操作", "close": "关闭", "cancel": "取消", "save": "创建", "mismatch": "两次输入的密码不一致。", "states": {"active": "可用", "used": "已用完", "expired": "已过期", "disabled": "已停用 / 组织不可用"}, "errors": {"invalid": "请检查组织、有效期、人数及填写内容。", "unavailable": "邀请码无效、已停用、已过期或名额已满。", "invalidLink": "验证链接已失效、邮箱已注册或邀请码已不可用，请重新申请或联系管理员。", "mailUnavailable": "邮件服务暂不可用或发送额度已用完，请稍后重试。"}}}, true, true);

i18n.addResourceBundle("en-US", "translation", {"invitation": {"title": "Invitation codes", "register": "Register with invitation", "create": "Create invitation", "code": "Invitation code", "note": "Note", "organization": "Organization", "creator": "Created by", "created": "Created", "expires": "Expires", "usage": "Used / limit", "days": "Valid for (days)", "limit": "Registration limit", "records": "Registration history", "reveal": "View code", "disable": "Disable", "disableConfirm": "Unfinished registrations will no longer be able to join. Disable this invitation?", "search": "Search note, organization or creator", "all": "All states", "allOrgs": "All organizations", "chooseOrg": "Choose organization", "empty": "No matching invitations", "noMembers": "No accounts have registered with this code", "joined": "Registered", "closed": "Closed account", "name": "Name", "email": "Email", "password": "Password", "confirmPassword": "Confirm password", "next": "Check invitation", "send": "Send verification email", "sent": "If this email is eligible and not rate limited, a verification email has been sent. Open it within 10 minutes. If it does not arrive, retry after 60 seconds. Existing accounts should sign in.", "join": "Joining: {{organization}}", "finish": "Verify email and create account", "done": "Account created and email verified. You can now sign in.", "copied": "Copied", "copy": "Copy code", "copyFailed": "Could not copy. Select and copy the code manually.", "help": "New codes contain 6 uppercase letters and are case-insensitive. Existing codes remain valid. Anyone holding the code can register and view shared organization projects. Default: one use; maximum: 90 days and 100 people. Expired codes stop working but their history remains. Existing accounts are unaffected.", "registerHelp": "The invitation determines your organization. Verify your email, then choose a name and password to create a customer account. Existing accounts cannot change organizations through invitations.", "refresh": "Refresh", "previous": "Previous", "nextPage": "Next", "page": "Page {{page}} · {{count}} records", "clear": "Clear filters", "status": "Status", "actions": "Actions", "close": "Close", "cancel": "Cancel", "save": "Create", "mismatch": "Passwords do not match.", "states": {"active": "Available", "used": "Used up", "expired": "Expired", "disabled": "Disabled / organization unavailable"}, "errors": {"invalid": "Check organization, validity, capacity and entered details.", "unavailable": "The invitation is invalid, disabled, expired or full.", "invalidLink": "The link expired, the email is registered, or the invitation is no longer available. Request a new link or contact an administrator.", "mailUnavailable": "Email is unavailable or the sending quota has been reached. Try again later."}}}, true, true);

i18n.addResourceBundle("zh-CN", "translation", {invitation:{nickname:"昵称",verifyEmail:"验证邮箱",submitRegistration:"注册",verified:"邮箱已验证，请设置密码后注册",registerHelp:"填写昵称、邮箱和邀请码，点击验证邮箱。在 10 分钟内打开邮件中的链接，设置密码后点击注册。邀请码决定所属组织，已有账号请直接登录。"}},true,true);
i18n.addResourceBundle("en-US", "translation", {invitation:{nickname:"Display name",verifyEmail:"Verify email",submitRegistration:"Register",verified:"Email verified. Set your password to register.",registerHelp:"Enter your display name, email and invitation code, then verify your email. Open the emailed link within 10 minutes, set a password and select Register. The invitation determines your organization. Existing users should sign in."}},true,true);

i18n.addResourceBundle("zh-CN","translation",{invitation:{accountAccess:"账号登录与注册"}},true,true);
i18n.addResourceBundle("en-US","translation",{invitation:{accountAccess:"Sign in or register"}},true,true);

i18n.addResourceBundle("zh-CN","translation",{invitation:{restart:"重新验证邮箱",passwordLength:"密码长度为 8–128 个字符，两次输入必须一致。"},formFeedback:{characters:"{{count}} / {{max}} 字符"}},true,true);
i18n.addResourceBundle("en-US","translation",{invitation:{restart:"Verify email again",passwordLength:"Use 8–128 characters. Both passwords must match."},formFeedback:{characters:"{{count}} / {{max}} characters"}},true,true);

i18n.addResourceBundle("zh-CN","translation",{accountSwitch:{needsLogin:"需重新登录",clearAll:"清除本机全部账号",clearConfirm:"清除本机保存的全部账号并退出当前登录？",logoutHint:"普通退出仅结束当前账号的登录，账号仍保留在本机列表；清除本机全部账号会移除列表并退出。",hint:"本机最多记住 5 个账号。登录过期后可点击账号重新验证；保持登录仅决定会话是否跨浏览器重启保留。"}},true,true);
i18n.addResourceBundle("en-US","translation",{accountSwitch:{needsLogin:"Sign in required",clearAll:"Clear all accounts on this device",clearConfirm:"Clear all saved accounts on this device and sign out?",logoutHint:"Signing out ends only the current session and keeps remembered accounts. Clearing all accounts removes the list and signs out.",hint:"Remember up to 5 accounts on this device. Select an expired account to sign in again. Keep me signed in controls session persistence across browser restarts."}},true,true);

i18n.addResourceBundle("zh-CN","translation",{invitation:{copyLink:"复制邀请链接"}},true,true);
i18n.addResourceBundle("en-US","translation",{invitation:{copyLink:"Copy invitation link"}},true,true);
